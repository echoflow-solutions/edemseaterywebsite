...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    {
      name: 'TikTok',
      href: 'https://tiktok.com/@edems.eatery',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <footer className="bg-primary text-white relative overflow-hidden">
      {/* Top decorative line with shimmer */}
      <div className="h-1 bg-gradient-to-r from-secondary via-yellow-300 to-secondary shimmer"></div>

      {/* Background decoration */}
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-secondary rounded-full filter blur-3xl"></div>
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-accent rounded-full filter blur-3xl"></div>
      </div>
        ...
        >
          ...
          <div className="text-center">
            ...
            <p className="text-white/40 text-xs">
              Designed and Developed by EchoFlow Solutions - info@echoflowsolutions.com.au
            </p>
          </div>
        </motion.div>
      </div>
